...
pub const memp_t_MEMP_ARP_QUEUE: memp_t = 7;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of stats_proto"][::std::mem::size_of::<stats_proto>() - 24usize];
    ["Alignment of stats_proto"][::std::mem::align_of::<stats_proto>() - 2usize];
    ["Offset of field: stats_proto::xmit"][::std::mem::offset_of!(stats_proto, xmit) - 0usize];
    ["Offset of field: stats_proto::recv"][::std::mem::offset_of!(stats_proto, recv) - 2usize];
    ["Offset of field: stats_proto::fw"][::std::mem::offset_of!(stats_proto, fw) - 4usize];
    ["Offset of field: stats_proto::drop"][::std::mem::offset_of!(stats_proto, drop) - 6usize];
    ["Offset of field: stats_proto::chkerr"][::std::mem::offset_of!(stats_proto, chkerr) - 8usize];
    ["Offset of field: stats_proto::lenerr"][::std::mem::offset_of!(stats_proto, lenerr) - 10usize];
    ["Offset of field: stats_proto::memerr"][::std::mem::offset_of!(stats_proto, memerr) - 12usize];
    ["Offset of field: stats_proto::rterr"][::std::mem::offset_of!(stats_proto, rterr) - 14usize];
    ["Offset of field: stats_proto::proterr"]
        [::std::mem::offset_of!(stats_proto, proterr) - 16usize];
    ["Offset of field: stats_proto::opterr"][::std::mem::offset_of!(stats_proto, opterr) - 18usize];
    ["Offset of field: stats_proto::err"][::std::mem::offset_of!(stats_proto, err) - 20usize];
    ["Offset of field: stats_proto::cachehit"]
        [::std::mem::offset_of!(stats_proto, cachehit) - 22usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of stats_igmp"][::std::mem::size_of::<stats_igmp>() - 28usize];
    ["Alignment of stats_igmp"][::std::mem::align_of::<stats_igmp>() - 2usize];
    ["Offset of field: stats_igmp::xmit"][::std::mem::offset_of!(stats_igmp, xmit) - 0usize];
    ["Offset of field: stats_igmp::recv"][::std::mem::offset_of!(stats_igmp, recv) - 2usize];
    ["Offset of field: stats_igmp::drop"][::std::mem::offset_of!(stats_igmp, drop) - 4usize];
    ["Offset of field: stats_igmp::chkerr"][::std::mem::offset_of!(stats_igmp, chkerr) - 6usize];
    ["Offset of field: stats_igmp::lenerr"][::std::mem::offset_of!(stats_igmp, lenerr) - 8usize];
    ["Offset of field: stats_igmp::memerr"][::std::mem::offset_of!(stats_igmp, memerr) - 10usize];
    ["Offset of field: stats_igmp::proterr"][::std::mem::offset_of!(stats_igmp, proterr) - 12usize];
    ["Offset of field: stats_igmp::rx_v1"][::std::mem::offset_of!(stats_igmp, rx_v1) - 14usize];
    ["Offset of field: stats_igmp::rx_group"]
        [::std::mem::offset_of!(stats_igmp, rx_group) - 16usize];
    ["Offset of field: stats_igmp::rx_general"]
        [::std::mem::offset_of!(stats_igmp, rx_general) - 18usize];
    ["Offset of field: stats_igmp::rx_report"]
        [::std::mem::offset_of!(stats_igmp, rx_report) - 20usize];
    ["Offset of field: stats_igmp::tx_join"][::std::mem::offset_of!(stats_igmp, tx_join) - 22usize];
    ["Offset of field: stats_igmp::tx_leave"]
        [::std::mem::offset_of!(stats_igmp, tx_leave) - 24usize];
    ["Offset of field: stats_igmp::tx_report"]
        [::std::mem::offset_of!(stats_igmp, tx_report) - 26usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of stats_mem"][::std::mem::size_of::<stats_mem>() - 16usize];
    ["Alignment of stats_mem"][::std::mem::align_of::<stats_mem>() - 4usize];
    ["Offset of field: stats_mem::avail"][::std::mem::offset_of!(stats_mem, avail) - 0usize];
    ["Offset of field: stats_mem::used"][::std::mem::offset_of!(stats_mem, used) - 4usize];
    ["Offset of field: stats_mem::max"][::std::mem::offset_of!(stats_mem, max) - 8usize];
    ["Offset of field: stats_mem::err"][::std::mem::offset_of!(stats_mem, err) - 12usize];
    ["Offset of field: stats_mem::illegal"][::std::mem::offset_of!(stats_mem, illegal) - 14usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of stats_syselem"][::std::mem::size_of::<stats_syselem>() - 6usize];
    ["Alignment of stats_syselem"][::std::mem::align_of::<stats_syselem>() - 2usize];
    ["Offset of field: stats_syselem::used"][::std::mem::offset_of!(stats_syselem, used) - 0usize];
    ["Offset of field: stats_syselem::max"][::std::mem::offset_of!(stats_syselem, max) - 2usize];
    ["Offset of field: stats_syselem::err"][::std::mem::offset_of!(stats_syselem, err) - 4usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of stats_sys"][::std::mem::size_of::<stats_sys>() - 18usize];
    ["Alignment of stats_sys"][::std::mem::align_of::<stats_sys>() - 2usize];
    ["Offset of field: stats_sys::sem"][::std::mem::offset_of!(stats_sys, sem) - 0usize];
    ["Offset of field: stats_sys::mutex"][::std::mem::offset_of!(stats_sys, mutex) - 6usize];
    ["Offset of field: stats_sys::mbox"][::std::mem::offset_of!(stats_sys, mbox) - 12usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct stats_ {
    ...
    pub tcp: stats_proto,
    pub mem: stats_mem,
    pub memp: [stats_mem; 10usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of stats_"][::std::mem::size_of::<stats_>() - 344usize];
    ["Alignment of stats_"][::std::mem::align_of::<stats_>() - 4usize];
    ["Offset of field: stats_::link"][::std::mem::offset_of!(stats_, link) - 0usize];
    ["Offset of field: stats_::etharp"][::std::mem::offset_of!(stats_, etharp) - 24usize];
    ["Offset of field: stats_::ip_frag"][::std::mem::offset_of!(stats_, ip_frag) - 48usize];
    ["Offset of field: stats_::ip"][::std::mem::offset_of!(stats_, ip) - 72usize];
    ["Offset of field: stats_::icmp"][::std::mem::offset_of!(stats_, icmp) - 96usize];
    ["Offset of field: stats_::udp"][::std::mem::offset_of!(stats_, udp) - 120usize];
    ["Offset of field: stats_::tcp"][::std::mem::offset_of!(stats_, tcp) - 144usize];
    ["Offset of field: stats_::mem"][::std::mem::offset_of!(stats_, mem) - 168usize];
    ["Offset of field: stats_::memp"][::std::mem::offset_of!(stats_, memp) - 184usize];
};
unsafe extern "C" {
