...
pub struct ip_reassdata {
    pub next: *mut ip_reassdata,
    pub p: *mut pbuf,
    pub iphdr: ip_hdr,
    pub datagram_len: u16_t,
    pub flags: u8_t,
    pub timer: u8_t,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ip_reassdata"][::std::mem::size_of::<ip_reassdata>() - 40usize];
    ["Alignment of ip_reassdata"][::std::mem::align_of::<ip_reassdata>() - 8usize];
    ["Offset of field: ip_reassdata::next"][::std::mem::offset_of!(ip_reassdata, next) - 0usize];
    ["Offset of field: ip_reassdata::p"][::std::mem::offset_of!(ip_reassdata, p) - 8usize];
    ["Offset of field: ip_reassdata::iphdr"][::std::mem::offset_of!(ip_reassdata, iphdr) - 16usize];
    ["Offset of field: ip_reassdata::datagram_len"]
        [::std::mem::offset_of!(ip_reassdata, datagram_len) - 36usize];
    ["Offset of field: ip_reassdata::flags"][::std::mem::offset_of!(ip_reassdata, flags) - 38usize];
    ["Offset of field: ip_reassdata::timer"][::std::mem::offset_of!(ip_reassdata, timer) - 39usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn ip_reass(p: *mut pbuf) -> *mut pbuf;
}
#[doc = " A custom pbuf that holds a reference to another pbuf, which is freed\n when this custom pbuf is freed. This is used to create a custom PBUF_REF\n that points into the original pbuf."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct pbuf_custom_ref {
    #[doc = " 'base class'"]
    pub pc: pbuf_custom,
    #[doc = " pointer to the original pbuf that is referenced"]
    pub original: *mut pbuf,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of pbuf_custom_ref"][::std::mem::size_of::<pbuf_custom_ref>() - 40usize];
    ["Alignment of pbuf_custom_ref"][::std::mem::align_of::<pbuf_custom_ref>() - 8usize];
    ["Offset of field: pbuf_custom_ref::pc"][::std::mem::offset_of!(pbuf_custom_ref, pc) - 0usize];
    ["Offset of field: pbuf_custom_ref::original"]
        [::std::mem::offset_of!(pbuf_custom_ref, original) - 32usize];
};
unsafe extern "C" {
    pub fn ip_frag(p: *mut pbuf, netif: *mut netif, dest: *mut ip_addr_t) -> err_t;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
