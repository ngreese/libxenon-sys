...
pub type raw_recv_fn = ::std::option::Option<
    unsafe extern "C" fn(
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of raw_pcb"][::std::mem::size_of::<raw_pcb>() - 48usize];
    ["Alignment of raw_pcb"][::std::mem::align_of::<raw_pcb>() - 8usize];
    ["Offset of field: raw_pcb::local_ip"][::std::mem::offset_of!(raw_pcb, local_ip) - 0usize];
    ["Offset of field: raw_pcb::remote_ip"][::std::mem::offset_of!(raw_pcb, remote_ip) - 4usize];
    ["Offset of field: raw_pcb::so_options"][::std::mem::offset_of!(raw_pcb, so_options) - 8usize];
    ["Offset of field: raw_pcb::tos"][::std::mem::offset_of!(raw_pcb, tos) - 9usize];
    ["Offset of field: raw_pcb::ttl"][::std::mem::offset_of!(raw_pcb, ttl) - 10usize];
    ["Offset of field: raw_pcb::next"][::std::mem::offset_of!(raw_pcb, next) - 16usize];
    ["Offset of field: raw_pcb::protocol"][::std::mem::offset_of!(raw_pcb, protocol) - 24usize];
    ["Offset of field: raw_pcb::recv"][::std::mem::offset_of!(raw_pcb, recv) - 32usize];
    ["Offset of field: raw_pcb::recv_arg"][::std::mem::offset_of!(raw_pcb, recv_arg) - 40usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn raw_recv(pcb: *mut raw_pcb, recv: raw_recv_fn, recv_arg: *mut ::std::os::raw::c_void);
}
unsafe extern "C" {
