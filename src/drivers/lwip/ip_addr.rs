...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ip_addr"][::std::mem::size_of::<ip_addr>() - 16usize];
    ["Alignment of ip_addr"][::std::mem::align_of::<ip_addr>() - 1usize];
...
unsafe extern "C" {
    pub fn ip_addr_netcmp(addr1: *mut ip_addr, addr2: *mut ip_addr, mask: *mut ip_addr) -> u8_t;
}
unsafe extern "C" {
    pub fn ip_addr_cmp(addr1: *mut ip_addr, addr2: *mut ip_addr) -> u8_t;
}
unsafe extern "C" {
    pub fn ip_addr_set(dest: *mut ip_addr, src: *mut ip_addr);
}
unsafe extern "C" {
    pub fn ip_addr_isany(addr: *mut ip_addr) -> u8_t;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
