...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of netbuf"][::std::mem::size_of::<netbuf>() - 24usize];
    ["Alignment of netbuf"][::std::mem::align_of::<netbuf>() - 8usize];
    ["Offset of field: netbuf::p"][::std::mem::offset_of!(netbuf, p) - 0usize];
    ["Offset of field: netbuf::ptr"][::std::mem::offset_of!(netbuf, ptr) - 8usize];
    ["Offset of field: netbuf::addr"][::std::mem::offset_of!(netbuf, addr) - 16usize];
    ["Offset of field: netbuf::port"][::std::mem::offset_of!(netbuf, port) - 20usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn netbuf_alloc(buf: *mut netbuf, size: u16_t) -> *mut ::std::os::raw::c_void;
}
unsafe extern "C" {
