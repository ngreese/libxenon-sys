...
pub const ICMP6_DUR: u32 = 1;
pub const ICMP6_TE: u32 = 3;
pub const ICMP6_ECHO: u32 = 128;
pub const ICMP6_ER: u32 = 129;
unsafe extern "C" {
    pub fn memcpy(
...
const _: () = {
    ...
    ["Alignment of icmp_echo_hdr"][::std::mem::align_of::<icmp_echo_hdr>() - 2usize];
    ["Offset of field: icmp_echo_hdr::type_"]
        [::std::mem::offset_of!(icmp_echo_hdr, type_) - 0usize];
    ["Offset of field: icmp_echo_hdr::icode"]
        [::std::mem::offset_of!(icmp_echo_hdr, icode) - 1usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of icmp_dur_hdr"][::std::mem::size_of::<icmp_dur_hdr>() - 8usize];
    ["Alignment of icmp_dur_hdr"][::std::mem::align_of::<icmp_dur_hdr>() - 4usize];
    ["Offset of field: icmp_dur_hdr::type_"][::std::mem::offset_of!(icmp_dur_hdr, type_) - 0usize];
    ["Offset of field: icmp_dur_hdr::icode"][::std::mem::offset_of!(icmp_dur_hdr, icode) - 1usize];
    ["Offset of field: icmp_dur_hdr::chksum"]
        [::std::mem::offset_of!(icmp_dur_hdr, chksum) - 2usize];
    ["Offset of field: icmp_dur_hdr::unused"]
        [::std::mem::offset_of!(icmp_dur_hdr, unused) - 4usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct icmp_te_hdr {
    pub type_: u8_t,
    pub icode: u8_t,
    pub chksum: u16_t,
    pub unused: u32_t,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of icmp_te_hdr"][::std::mem::size_of::<icmp_te_hdr>() - 8usize];
    ["Alignment of icmp_te_hdr"][::std::mem::align_of::<icmp_te_hdr>() - 4usize];
    ["Offset of field: icmp_te_hdr::type_"][::std::mem::offset_of!(icmp_te_hdr, type_) - 0usize];
    ["Offset of field: icmp_te_hdr::icode"][::std::mem::offset_of!(icmp_te_hdr, icode) - 1usize];
    ["Offset of field: icmp_te_hdr::chksum"][::std::mem::offset_of!(icmp_te_hdr, chksum) - 2usize];
    ["Offset of field: icmp_te_hdr::unused"][::std::mem::offset_of!(icmp_te_hdr, unused) - 4usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
