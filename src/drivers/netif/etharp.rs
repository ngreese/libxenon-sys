...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of eth_addr"][::std::mem::size_of::<eth_addr>() - 6usize];
    ["Alignment of eth_addr"][::std::mem::align_of::<eth_addr>() - 1usize];
    ["Offset of field: eth_addr::addr"][::std::mem::offset_of!(eth_addr, addr) - 0usize];
};
#[doc = " Ethernet header"]
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of eth_hdr"][::std::mem::size_of::<eth_hdr>() - 14usize];
    ["Alignment of eth_hdr"][::std::mem::align_of::<eth_hdr>() - 1usize];
    ["Offset of field: eth_hdr::dest"][::std::mem::offset_of!(eth_hdr, dest) - 0usize];
    ["Offset of field: eth_hdr::src"][::std::mem::offset_of!(eth_hdr, src) - 6usize];
    ["Offset of field: eth_hdr::type_"][::std::mem::offset_of!(eth_hdr, type_) - 12usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of etharp_hdr"][::std::mem::size_of::<etharp_hdr>() - 28usize];
    ["Alignment of etharp_hdr"][::std::mem::align_of::<etharp_hdr>() - 1usize];
    ["Offset of field: etharp_hdr::hwtype"][::std::mem::offset_of!(etharp_hdr, hwtype) - 0usize];
    ["Offset of field: etharp_hdr::proto"][::std::mem::offset_of!(etharp_hdr, proto) - 2usize];
    ["Offset of field: etharp_hdr::hwlen"][::std::mem::offset_of!(etharp_hdr, hwlen) - 4usize];
    ["Offset of field: etharp_hdr::protolen"]
        [::std::mem::offset_of!(etharp_hdr, protolen) - 5usize];
    ["Offset of field: etharp_hdr::opcode"][::std::mem::offset_of!(etharp_hdr, opcode) - 6usize];
    ["Offset of field: etharp_hdr::shwaddr"][::std::mem::offset_of!(etharp_hdr, shwaddr) - 8usize];
    ["Offset of field: etharp_hdr::sipaddr"][::std::mem::offset_of!(etharp_hdr, sipaddr) - 14usize];
    ["Offset of field: etharp_hdr::dhwaddr"][::std::mem::offset_of!(etharp_hdr, dhwaddr) - 18usize];
    ["Offset of field: etharp_hdr::dipaddr"][::std::mem::offset_of!(etharp_hdr, dipaddr) - 24usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of etharp_q_entry"][::std::mem::size_of::<etharp_q_entry>() - 16usize];
    ["Alignment of etharp_q_entry"][::std::mem::align_of::<etharp_q_entry>() - 8usize];
    ["Offset of field: etharp_q_entry::next"]
        [::std::mem::offset_of!(etharp_q_entry, next) - 0usize];
    ["Offset of field: etharp_q_entry::p"][::std::mem::offset_of!(etharp_q_entry, p) - 8usize];
};
unsafe extern "C" {
    pub fn etharp_tmr();
}
...
unsafe extern "C" {
    pub fn etharp_arp_input(netif: *mut netif, ethaddr: *mut eth_addr, p: *mut pbuf);
}
unsafe extern "C" {
    pub fn etharp_ip_input(netif: *mut netif, p: *mut pbuf);
}
unsafe extern "C" {
