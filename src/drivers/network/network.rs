...
pub const LWIP_DHCP_BOOTP_FILE: u32 = 1;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of udp_hdr"][::std::mem::size_of::<udp_hdr>() - 8usize];
    ["Alignment of udp_hdr"][::std::mem::align_of::<udp_hdr>() - 1usize];
    ["Offset of field: udp_hdr::src"][::std::mem::offset_of!(udp_hdr, src) - 0usize];
    ["Offset of field: udp_hdr::dest"][::std::mem::offset_of!(udp_hdr, dest) - 2usize];
    ["Offset of field: udp_hdr::len"][::std::mem::offset_of!(udp_hdr, len) - 4usize];
    ["Offset of field: udp_hdr::chksum"][::std::mem::offset_of!(udp_hdr, chksum) - 6usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of udp_pcb"][::std::mem::size_of::<udp_pcb>() - 48usize];
    ["Alignment of udp_pcb"][::std::mem::align_of::<udp_pcb>() - 8usize];
    ["Offset of field: udp_pcb::local_ip"][::std::mem::offset_of!(udp_pcb, local_ip) - 0usize];
    ["Offset of field: udp_pcb::remote_ip"][::std::mem::offset_of!(udp_pcb, remote_ip) - 4usize];
    ["Offset of field: udp_pcb::so_options"][::std::mem::offset_of!(udp_pcb, so_options) - 8usize];
    ["Offset of field: udp_pcb::tos"][::std::mem::offset_of!(udp_pcb, tos) - 9usize];
    ["Offset of field: udp_pcb::ttl"][::std::mem::offset_of!(udp_pcb, ttl) - 10usize];
    ["Offset of field: udp_pcb::next"][::std::mem::offset_of!(udp_pcb, next) - 16usize];
    ["Offset of field: udp_pcb::flags"][::std::mem::offset_of!(udp_pcb, flags) - 24usize];
    ["Offset of field: udp_pcb::local_port"][::std::mem::offset_of!(udp_pcb, local_port) - 26usize];
    ["Offset of field: udp_pcb::remote_port"]
        [::std::mem::offset_of!(udp_pcb, remote_port) - 28usize];
    ["Offset of field: udp_pcb::recv"][::std::mem::offset_of!(udp_pcb, recv) - 32usize];
    ["Offset of field: udp_pcb::recv_arg"][::std::mem::offset_of!(udp_pcb, recv_arg) - 40usize];
};
unsafe extern "C" {
...
pub struct dhcp {
    ...
    pub offered_si_addr: ip_addr_t,
    pub boot_server_name: [::std::os::raw::c_char; 64usize],
    pub boot_file_name: [::std::os::raw::c_char; 128usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of dhcp"][::std::mem::size_of::<dhcp>() - 280usize];
    ["Alignment of dhcp"][::std::mem::align_of::<dhcp>() - 8usize];
    ["Offset of field: dhcp::xid"][::std::mem::offset_of!(dhcp, xid) - 0usize];
    ["Offset of field: dhcp::pcb"][::std::mem::offset_of!(dhcp, pcb) - 8usize];
    ["Offset of field: dhcp::msg_in"][::std::mem::offset_of!(dhcp, msg_in) - 16usize];
    ["Offset of field: dhcp::state"][::std::mem::offset_of!(dhcp, state) - 24usize];
    ["Offset of field: dhcp::tries"][::std::mem::offset_of!(dhcp, tries) - 25usize];
    ["Offset of field: dhcp::subnet_mask_given"]
        [::std::mem::offset_of!(dhcp, subnet_mask_given) - 26usize];
    ["Offset of field: dhcp::p_out"][::std::mem::offset_of!(dhcp, p_out) - 32usize];
    ["Offset of field: dhcp::msg_out"][::std::mem::offset_of!(dhcp, msg_out) - 40usize];
    ["Offset of field: dhcp::options_out_len"]
        [::std::mem::offset_of!(dhcp, options_out_len) - 48usize];
    ["Offset of field: dhcp::request_timeout"]
        [::std::mem::offset_of!(dhcp, request_timeout) - 50usize];
    ["Offset of field: dhcp::t1_timeout"][::std::mem::offset_of!(dhcp, t1_timeout) - 52usize];
    ["Offset of field: dhcp::t2_timeout"][::std::mem::offset_of!(dhcp, t2_timeout) - 54usize];
    ["Offset of field: dhcp::server_ip_addr"]
        [::std::mem::offset_of!(dhcp, server_ip_addr) - 56usize];
    ["Offset of field: dhcp::offered_ip_addr"]
        [::std::mem::offset_of!(dhcp, offered_ip_addr) - 60usize];
    ["Offset of field: dhcp::offered_sn_mask"]
        [::std::mem::offset_of!(dhcp, offered_sn_mask) - 64usize];
    ["Offset of field: dhcp::offered_gw_addr"]
        [::std::mem::offset_of!(dhcp, offered_gw_addr) - 68usize];
    ["Offset of field: dhcp::offered_t0_lease"]
        [::std::mem::offset_of!(dhcp, offered_t0_lease) - 72usize];
    ["Offset of field: dhcp::offered_t1_renew"]
        [::std::mem::offset_of!(dhcp, offered_t1_renew) - 76usize];
    ["Offset of field: dhcp::offered_t2_rebind"]
        [::std::mem::offset_of!(dhcp, offered_t2_rebind) - 80usize];
    ["Offset of field: dhcp::offered_si_addr"]
        [::std::mem::offset_of!(dhcp, offered_si_addr) - 84usize];
    ["Offset of field: dhcp::boot_server_name"]
        [::std::mem::offset_of!(dhcp, boot_server_name) - 88usize];
    ["Offset of field: dhcp::boot_file_name"]
        [::std::mem::offset_of!(dhcp, boot_file_name) - 152usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of dhcp_msg"][::std::mem::size_of::<dhcp_msg>() - 308usize];
    ["Alignment of dhcp_msg"][::std::mem::align_of::<dhcp_msg>() - 1usize];
    ["Offset of field: dhcp_msg::op"][::std::mem::offset_of!(dhcp_msg, op) - 0usize];
    ["Offset of field: dhcp_msg::htype"][::std::mem::offset_of!(dhcp_msg, htype) - 1usize];
    ["Offset of field: dhcp_msg::hlen"][::std::mem::offset_of!(dhcp_msg, hlen) - 2usize];
    ["Offset of field: dhcp_msg::hops"][::std::mem::offset_of!(dhcp_msg, hops) - 3usize];
    ["Offset of field: dhcp_msg::xid"][::std::mem::offset_of!(dhcp_msg, xid) - 4usize];
    ["Offset of field: dhcp_msg::secs"][::std::mem::offset_of!(dhcp_msg, secs) - 8usize];
    ["Offset of field: dhcp_msg::flags"][::std::mem::offset_of!(dhcp_msg, flags) - 10usize];
    ["Offset of field: dhcp_msg::ciaddr"][::std::mem::offset_of!(dhcp_msg, ciaddr) - 12usize];
    ["Offset of field: dhcp_msg::yiaddr"][::std::mem::offset_of!(dhcp_msg, yiaddr) - 16usize];
    ["Offset of field: dhcp_msg::siaddr"][::std::mem::offset_of!(dhcp_msg, siaddr) - 20usize];
    ["Offset of field: dhcp_msg::giaddr"][::std::mem::offset_of!(dhcp_msg, giaddr) - 24usize];
    ["Offset of field: dhcp_msg::chaddr"][::std::mem::offset_of!(dhcp_msg, chaddr) - 28usize];
    ["Offset of field: dhcp_msg::sname"][::std::mem::offset_of!(dhcp_msg, sname) - 44usize];
    ["Offset of field: dhcp_msg::file"][::std::mem::offset_of!(dhcp_msg, file) - 108usize];
    ["Offset of field: dhcp_msg::cookie"][::std::mem::offset_of!(dhcp_msg, cookie) - 236usize];
    ["Offset of field: dhcp_msg::options"][::std::mem::offset_of!(dhcp_msg, options) - 240usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn network_print_config();
}
unsafe extern "C" {
    pub static mut netif: netif;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
