...
pub const USBSTORAGE_ETIMEDOUT: i32 = -110;
...
pub struct usbstorage_handle {
    ...
    pub ep_out: u8_,
    pub max_lun: u8_,
    pub sector_size: [u32_; 16usize],
    pub n_sector: [u32_; 16usize],
    pub usb_fd: *mut ehci_device,
    pub retval: s32,
    pub tag: u32_,
    pub ata_protocol: u8_,
    pub buffer: *mut u8_,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of usbstorage_handle"][::std::mem::size_of::<usbstorage_handle>() - 176usize];
    ["Alignment of usbstorage_handle"][::std::mem::align_of::<usbstorage_handle>() - 8usize];
    ["Offset of field: usbstorage_handle::configuration"]
        [::std::mem::offset_of!(usbstorage_handle, configuration) - 0usize];
    ["Offset of field: usbstorage_handle::interface"]
        [::std::mem::offset_of!(usbstorage_handle, interface) - 4usize];
    ["Offset of field: usbstorage_handle::altInterface"]
        [::std::mem::offset_of!(usbstorage_handle, altInterface) - 8usize];
    ["Offset of field: usbstorage_handle::ep_in"]
        [::std::mem::offset_of!(usbstorage_handle, ep_in) - 12usize];
    ["Offset of field: usbstorage_handle::ep_out"]
        [::std::mem::offset_of!(usbstorage_handle, ep_out) - 13usize];
    ["Offset of field: usbstorage_handle::max_lun"]
        [::std::mem::offset_of!(usbstorage_handle, max_lun) - 14usize];
    ["Offset of field: usbstorage_handle::sector_size"]
        [::std::mem::offset_of!(usbstorage_handle, sector_size) - 16usize];
    ["Offset of field: usbstorage_handle::n_sector"]
        [::std::mem::offset_of!(usbstorage_handle, n_sector) - 80usize];
    ["Offset of field: usbstorage_handle::usb_fd"]
        [::std::mem::offset_of!(usbstorage_handle, usb_fd) - 144usize];
    ["Offset of field: usbstorage_handle::retval"]
        [::std::mem::offset_of!(usbstorage_handle, retval) - 152usize];
    ["Offset of field: usbstorage_handle::tag"]
        [::std::mem::offset_of!(usbstorage_handle, tag) - 156usize];
    ["Offset of field: usbstorage_handle::ata_protocol"]
        [::std::mem::offset_of!(usbstorage_handle, ata_protocol) - 160usize];
    ["Offset of field: usbstorage_handle::buffer"]
        [::std::mem::offset_of!(usbstorage_handle, buffer) - 168usize];
};
unsafe extern "C" {
    pub fn USBStorage_Umount();
}
unsafe extern "C" {
    pub fn USBStorage_Close(dev: *mut usbstorage_handle) -> s32;
}
unsafe extern "C" {
    pub fn USBStorage_Reset(ehci: *mut ehci_hcd, dev: *mut usbstorage_handle) -> s32;
}
unsafe extern "C" {
    pub fn USBStorage_GetMaxLUN(dev: *mut usbstorage_handle) -> s32;
}
unsafe extern "C" {
    pub fn USBStorage_MountLUN(ehci: *mut ehci_hcd, dev: *mut usbstorage_handle, lun: u8_) -> s32;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn USBStorage_Inquiry(ehci: *mut ehci_hcd, dev: *mut usbstorage_handle, lun: u8_) -> s32;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ehci_itd {
